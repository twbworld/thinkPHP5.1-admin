...
var CanvasParticle = (function() {
    ...
    function canvasInit(canvasConfig) {
        ...
        // 获取body作为背景
        var bodycolor = getElementByTag("body")[0];

        // 获取特定div作为背景
        // mybg是你想要将其作为背景的div的ID
        var body = document.getElementById("mybg");
        ...
        body.style.margin = "0";
        body.style.height = window.screen.availHeight + 'px'; //获取浏览器高度
        bodycolor.style.backgroundColor = "#2D2D2D"; //页面背景为#2D2D2D
    ...
    function canvasSize(canvas) {
        ...
        // 获取特定div的宽高
        var width = document.getElementById("mybg").style.width;
        var height = document.getElementById("mybg").style.height;
